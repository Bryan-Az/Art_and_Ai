...
roletype,
role,
displaydate as displaydate_artistAssigned,
beginyear as beginyear_artistAssigned,
endyear as endyear_artistAssigned,
b.country as country_artistAssigned,
zipcode as zipcode_artistAssigned,
ulanid,
forwarddisplayname,
artistofngaobject,
x.beginyear as birthyear,
x.endyear as deathyear, 
nationality,
constituenttype,
Demonym as demonym,
pct_country_NGA,
